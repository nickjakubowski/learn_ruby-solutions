...
describe "#multiply" do
  ...
  it "multiplies several numbers" do
    multiply([4,5,6,8]).should == 960
  end
  
  it "multiplies numbers by zero" do
    multiply([5,4,6,0]).should == 0
  end
end

describe "#power" do
  it "raises one number to the power of another number" do
    power(5,3).should == 125.0
  end
  
  it "raises one number to zero" do
    power(5,0).should == 1.0
  end
  
  it "raises one number to a negative number" do
    power(8,-1).should == 0.125
  end  
end
