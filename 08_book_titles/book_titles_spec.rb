  ...
  describe 'title' do
    ...
    describe 'should capitalize every word except...' do
      ...
      specify 'prepositions' do
       ...
       specify 'ignore numbers' do
        @book.title = "5 very good reasons to punch a dolphin in the mouth"
        @book.title.should == "5 Very Good Reasons to Punch a Dolphin in the Mouth"
      end 
    end
